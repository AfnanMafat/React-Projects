    ...
    {isLoading ? (
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 to-blue-900 flex items-center justify-center">
          <div className="text-center">
            ...
            <h2 className="mt-6 text-2xl font-bold bg-gradient-to-r from-yellow-400 to-red-500 bg-clip-text text-transparent">
              Loading Movie Magic
            </h2>
            <p className="mt-2 text-blue-300 max-w-md mx-auto">
              Gathering all the cinematic details for {n} ({r})
            </p>
          </div>
        </div>
      ) : Fetch ? (
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 to-blue-900 flex items-center justify-center">
          <div className="text-center p-8 bg-gray-800 bg-opacity-70 backdrop-blur-lg rounded-2xl max-w-md">
            ...
            <p className="text-blue-200 mb-6">
              Couldn't find "{n}" ({r}) in our database
            </p>
            <Link
              to="/"
              className="inline-block px-6 py-3 bg-gradient-to-r from-gray-600 to-gray-800 text-white font-bold rounded-lg hover:opacity-90 transition-all"
            >
              Try Another Search
            </Link>
          </div>
